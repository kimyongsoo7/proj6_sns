...
?>
            ...
            <div><p><a href="/board3/write/<?php echo $this->uri->segment(3);?>/page/<?php echo $this->uri->segment(5);?>" class="btn btn-success">쓰기</a></p></div>
		<div>
<?php
            echo form_open('board3/lists/ci_board', array('id'=>'bd_search', 'class'=>'well form-search'));
?>            
