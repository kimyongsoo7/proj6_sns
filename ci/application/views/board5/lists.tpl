        ...
        $(document).ready(function(){
            $("#search_btn").click(function(){
                if($("#q").val() == ''){
                    ...
                    var act = '/board5/lists/ci_board/q/'+$("#q").val()+'/page/1';
...
{/}
            ...
            <tfoot>
                <tr>
                    ...
                    <div><p><a href="/board5/write/{seg_3}/page/{seg_5}" class="btn btn-success">쓰기</a></p></div>
                    <div>
                        <form id="bd_search" method="post" class="well form-search" action="/board5/lists/ci_board">
